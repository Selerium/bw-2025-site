...
<template>
    <div class="w-full xl:w-1/3 grow flex flex-col items-start gap-1">
        ...
        <input :disabled="props.disabled" v-model="modelValue" required :placeholder="props.placeholder" :class="extraCss" class="font-semibold rounded-lg w-full full text-left border p-2 pt-3 h-12 disabled:cursor-not-allowed disabled:opacity-50" :type="inputType"></input>
    </div>
</template>
